    ...
    **Что такое OSI**
    ...
    !!! note ""
        **Канальный уровень (Data Link Layer):**
        <br>
            Обеспечение надежной передачи данных между двумя узлами, обнаружение и коррекция ошибок.
        <br>
    ...
    !!! note ""
        **Сетевой уровень (Network Layer):**
        <br>
            Маршрутизация данных между различными сетями, определение пути передачи.
        <br>
    ...
    !!! note ""
        **Транспортный уровень (Transport Layer):**
        <br>
            Обеспечение надежной передачи данных между приложениями, управление потоком данных.
        <br>
    ...
    !!! note ""
        **Сеансовый уровень (Session Layer):**
        <br>
            Управление соединениями между приложениями, установление, поддержание и разрыв сеансов связи.
        <br>
    ...
    !!! note ""
        **Представительский уровень (Presentation Layer):**
        <br>
        Преобразование данных в формат, понятный приложениям, шифрование и декодирование.
        <br>
    ...
    !!! note ""
        **Прикладной уровень (Application Layer):**
        <br>
            Предоставление интерфейса для взаимодействия с пользователем, управление приложениями.
        <br>
